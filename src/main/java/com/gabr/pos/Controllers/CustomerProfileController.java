...
import com.gabr.pos.PDF.salesReport;
...
import com.gabr.pos.models.invoice;
import com.gabr.pos.models.sales;
import java.awt.Desktop;

import static com.gabr.pos.Services.SettingService.CUSTOMER_SALES_FOLDER;
...
//    private TableColumn<String, String> paidTypeCol;
    ...
    private void getData(String query) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "getData", ex);
        }
    }
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource(EDIT_SALES_PAGE));
                            try {
                                loader.load();
                            ...
                            editSalesController.setTextField(sale, true, customerNameField.getText(), Integer.parseInt(customer_id_field.getText()));
    ...
    public void setTextField(int cusId, String name) {

        customer_id_field.setText(cusId + "");
        customerNameField.setText(name);
        customer_id_field.setVisible(false);

        salesfileLocation = REPORT_MAIN_FOLDER + CUSTOMER_SALES_FOLDER + "//" + name;
    ...
    public void getAllRemain() {
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "getAllRemain", ex);
        }
    }
    ...
    private void openAddInv(MouseEvent event) {
        ...
        close(event);
        openAddOutInv(Integer.parseInt(customer_id_field.getText()), customerNameField.getText());
    }

    public void openAddOutInv(int cusId, String customerName) {

        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/screen/addOutInv.fxml"));
            loader.load();

            AddOutSalesController addOutSalesController = loader.getController();
            addOutSalesController.setTextField(cusId, customerName);
            Parent parent = loader.getRoot();
            Stage stage = new Stage();
            stage.setScene(new Scene(parent));
            stage.setTitle("العميل:  " + customerName);
            stage.getIcons().add(new Image(getClass().getResourceAsStream(iconImagePath)));
            stage.setOnCloseRequest(event -> OPEN_CUSTOMER_PROFILE(cusId, customerName));
            stage.show();
        } catch (Exception ex) {
            LOG_EXCEP(this.getClass().getName(), "openAddOutInv", ex);
        }
    ...
    public String sumPaidM(String code, int id, int cus_id) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "sumPaidM", ex);
        }

        return total_paid;
    }

    public void openDetailsPage(sales sale) {

        loadInvoiceData(sale.getId(), sale.getCus_id(), sale.getCode());
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/screen/editInvoice.fxml"));
            loader.load();
            ...
            stage.setOnCloseRequest(event -> OPEN_CUSTOMER_PROFILE(sale.getCus_id(), sale.getCustomerName()));
            stage.show();
        } catch (Exception ex) {
            LOG_EXCEP(this.getClass().getName(), "openDetailsPage", ex);
        }
    }
    ...
    public void loadInvoiceData(int salesId, int cus_id, String code) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "loadInvoiceData", ex);
        }
    ...
    private void getPaySalesData(String query, int cus_id, int INV_ID, boolean out) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "getPaySalesData", ex);
        }
    }
    ...
    private void getUserPaySalesData(String query) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "getUserPaySalesData", ex);
        }
    }
