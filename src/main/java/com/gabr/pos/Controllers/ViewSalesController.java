...
import static com.gabr.pos.Services.WindowUtils.OPEN_SALES_PAGE;
import static com.gabr.pos.Services.WindowUtils.OPEN_WINDOW;
...
public class ViewSalesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        invoicefileLocation = REPORT_MAIN_FOLDER + INV_FOLDER + "//";

        salesfileLocation = REPORT_MAIN_FOLDER + SALES_FOLDER;
                        ...
                        open.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            if (!pdf.exists()) {
                                ...
                                try {
                                    ...
                                    LOG_EXCEP(this.getClass().getName(), "loadData - open", ex);
                                }
                            }
    ...
    public void setTextField(LocalDate from, LocalDate to) {
    ...
    public void openDetailsPage(sales sale) {
        ...
        try {
            ...
            stage.setOnCloseRequest(event -> OPEN_SALES_PAGE(from_date.getValue(), to_date.getValue()));
            stage.show();
        } catch (Exception ex) {
    ...
    public String sumPaid(String code, int cus_id) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "sumPaid", ex);
        }
