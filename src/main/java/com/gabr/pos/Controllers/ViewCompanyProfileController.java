...
import com.gabr.pos.models.customerInv;
...
import static com.gabr.pos.Services.SettingService.COMPANY_SALES_FOLDER;
...
public class ViewCompanyProfileController implements Initializable {
    ...
    private void addItemToInvoice(MouseEvent event) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "addItemToInvoice", ex);
        }
    }
    ...
    void setTextField(int cusId, String name) {
        customer_id = cusId;
    ...
    private void getBetweenDate() {
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "getBetweenDate", ex);
        }
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            /*
                             ...
                             loader.setLocation(getClass().getResource("editSales.fxml"));
                             try {
                             loader.load();
    ...
    private void save(MouseEvent event) {
        ...
        String salesfileLocation = REPORT_MAIN_FOLDER + COMPANY_SALES_FOLDER;
