...
import static com.gabr.pos.Services.SettingService.INV_FOLDER;
...
public class editInvoiceController implements Initializable {
    ...
    private void printInvoice() {
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "printInvoice", ex);
        }
    ...
    private void printInvoiceAndPay() {
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "printInvoiceAndPay", ex);
        }
    }
