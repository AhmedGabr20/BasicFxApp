...
public class ViewCompanesController implements Initializable {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        open.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            custmr = customerTable.getSelectionModel().getSelectedItem();
                            openCompanyProfile(custmr.getId(), custmr.getName());
    ...
    public void openCompanyProfile(int cusId, String name) {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/screen/viewCompanyProfile.fxml"));
            loader.load();
            ViewCompanyProfileController viewCompanyProfile = loader.getController();
            viewCompanyProfile.setTextField(cusId, name);
            ...
            stage.setOnCloseRequest(event -> OPEN_COMPANIES_PAGE());
            stage.show();
        } catch (Exception ex) {
            LOG_EXCEP(this.getClass().getName(), "openCompanyProfile", ex);
        }

    }


    public void openEditCompanePage(customer customer) {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/screen/addCompany.fxml"));
            loader.load();
            ...
            LOG_EXCEP(this.getClass().getName(), "openEditCompanePage", ex);
        }
    }
