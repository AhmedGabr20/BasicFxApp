...
import com.gabr.pos.PDF.ReceiptTemplete;
...
public class EditSalesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        receiptLocation = REPORT_MAIN_FOLDER + CUSTOMER_SALES_FOLDER;
    ...
    private int insertOutSales() {
        ...
        try {
           if (CODE.contains("OT")) {
            ...
            LOG_EXCEP(this.getClass().getName(), "insertOutSales", ex);
        }
        return result;
    }

    void setTextField(sales sale, boolean edit, String customerName, int customerId) {
    ...
    public void printReceit(String userName) {
        ...
        if (updateSales) {
            try {
                ...
                receiptTemplete.openDocument(pdfName + ".pdf", receiptLocation + "//" + customerName + RECEIPT_FOLDER);
                ...
                try {
                    Desktop.getDesktop().open(new File(receiptLocation + "//" + customerName + RECEIPT_FOLDER));
                } catch (IOException ex) {
                    Logger.getLogger(AddCustomerController.class.getName()).log(Level.SEVERE, null, ex);
                }

            } catch (Exception ex) {
                LOG_EXCEP(this.getClass().getName(), "printReceit", ex);
            }
        }
