...
import com.gabr.pos.PDF.ReportTemplete;
import com.gabr.pos.models.User;
import com.gabr.pos.models.UserContext;
import com.gabr.pos.models.sales;
...
import static com.gabr.pos.Services.WindowUtils.OPEN_DASHBOARD_PAGE;
...
public class DashBoardController implements Initializable {
    ...
    int IS_SHOW_ADVANCED = 0;
    @FXML
    private Button showAdvancedBTN;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        IS_SHOW_ADVANCED = isShowAdvanced();
        if (IS_SHOW_ADVANCED == 0) {
            showAdvancedBTN.setText("اظهار");
        } else {
            showAdvancedBTN.setText("اخفاء");
        }
    ...
    public void openEditUser(int AdminID, int Admin_Role, int UserID, String name, String phone, String password, String User_Role, boolean update) {
        try {
            ...
            loader.setLocation(getClass().getResource("/screen/addUser.fxml"));
            loader.load();
            ...
            stage.getIcons().add(new Image(getClass().getResourceAsStream("/images/company_logo.png")));
            stage.setOnCloseRequest(event -> OPEN_DASHBOARD_PAGE());
            stage.show();
        } catch (Exception ex) {
            LOG_EXCEP(this.getClass().getName(), "openEditUser", ex);
        }
    }
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                            ...
                            alert.showAndWait().ifPresent(response -> {
                                if (response == ButtonType.OK) {
                                    try {
                                        ...
                                        LOG_EXCEP(this.getClass().getName(), "loadDate - delete", ex);
                        ...
                        open.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            selectedUser = usersTable.getSelectionModel().getSelectedItem();
                            FXMLLoader loader = new FXMLLoader();
                            loader.setLocation(getClass().getResource("/screen/userProfile.fxml"));
                            try {
                                loader.load();
                            } catch (Exception ex) {
                                LOG_EXCEP(this.getClass().getName(), "loadDate - open", ex);
                            }
    ...
    private void calcAllTotals() {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "calcAllTotals", ex);
        }
    ...
    private void calcAllExpenses() {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "calcAllExpenses", ex);
        }
    ...
    private void inv_folder(MouseEvent event) {
        ...
        String invLocation = REPORT_MAIN_FOLDER + INV_FOLDER;
    ...
    private void sales_folder(MouseEvent event) {
        ...
        String salesfileLocation = REPORT_MAIN_FOLDER + SALES_FOLDER;
    ...
    public void openFolder(String location) {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "openFolder", ex);
        }
    }
    ...
    public int totalCustomers() {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "totalCustomers", ex);
        }
    ...
    public void backUpMethod() {
        ...
        try {
            ...
            File f1 = new File(BACKP_FOLDER);
            f1.mkdir();
            String savePath = BACKP_FOLDER + "\\backUp" + "elnoor"+currentDate+".sql";
            ...
            String executeCmd = "c:\\Program Files\\MySQL\\MySQL Workbench 8.0\\mysqldump --no-defaults --user=" + DATABASE_USER + "  --password=" + DATABASE_PASS + "  -h localhost " + DATABASE_NAME + " -r " + savePath;
            ...
            LOG_EXCEP(this.getClass().getName(), "backUpMethod", ex);
        }
    ...
    private void save(MouseEvent event) {
        ...
        String path = REPORT_MAIN_FOLDER + REV_AND_EXP_FOLDER;
    ...
    public void sendMail() {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "sendMail", ex);
        }

    }

    @FXML
    private void showAdvanced(MouseEvent event) {
        try {

            connection = DbConnect.getConnect();
            query = "UPDATE `showadvanced` SET "
                    + "`storePrice`=? ";
            preparedStatement = connection.prepareStatement(query);
            if (IS_SHOW_ADVANCED == 0) {
            ...
            LOG_EXCEP(this.getClass().getName(), "showAdvanced", ex);
        }
    }

    public int isShowAdvanced() {
        ...
        try {
            ...
            LOG_EXCEP(this.getClass().getName(), "isShowAdvanced", ex);
        }
        return code;
    }
}
